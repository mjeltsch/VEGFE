...
def run():
    ...
    sequences = 'vegfe_modified_names.fasta'
    aligned_sequences = 'vegfe_aligned.fasta'
    list_file_name = "vegfe.lst"
    encoded_aligned_sequences = 'vegfe_aligned_encoded.fasta'
    phylip_file = 'vegfe.phylip'
    phyml_output_file = 'phyml_result'
    final_tree = 'vegfe.tree'
    svg_file = 'vegfe_tree.svg'
    svg_file_collapsed = 'vegfe_tree_small.svg'
    ...
    t.set_outgroup(t & 'SSV_Lagothrix_lagotricha_P01128.1')
    # Swapping children
